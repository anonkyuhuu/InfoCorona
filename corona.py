...
class Corona:
 ...
 def indonesia(self):
  ...
  for x in self.b:
   ...
   runtext.load('\x1b[37m[\x1b[32;1m*\x1b[37m]\x1b[32;1m Recovery : '+x['sembuh'])
  ...
  if 'y' in self.ask:
   ...
   for a in n:
    ...
    print('\x1b[37m[\x1b[32;1m*\x1b[37m]\x1b[32;1m Recovery : '+str(a['Kasus_Semb']))
...
\x1b[37m[\x1b[32;1m*\x1b[37m]\x1b[32;1m Recovery : {}
